...
class OpenCommand extends Command
{
    ...
    {
	    $this
	        ->setDescription('Open the Linux Terminal')
	        ->setHelp('set description here...')
			;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
		...
		$output->writeln([
		            ...
		            '<info>=============================================</>',
		            '<info>=============================================</>',
		            '<info>   		Friendly Linux Commandline</>',
		            '<info>=============================================</>',
		            '<info>=============================================</>',
		            '',
		            '',
		            'Linux is a great system but the commandline can be frustrating.',
		            'Friendly Linux Commandline takes the fuss out of the terinal.'
		            '',
		            '<question>Exit with [ctrl] + [c]</question>',
		            ''
		            ''
		        ]);
